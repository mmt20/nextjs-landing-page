...
const Contact = () => {
  return (
    <section className="pt-16 pb-16">
      ...
      <button className=" mt-8 flex items-center  gap-2 bg-pink-600 text-white font-semibold text-sm sm:text-base px-6 py-4 rounded-md shadow-md hover:bg-pink-700 transition duration-300 ease-in-out mx-auto cursor-pointer">
